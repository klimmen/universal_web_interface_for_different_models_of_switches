...
class SwitchesControllerTest < ActionController::TestCase
  ...
  test "should create switch" do
    assert_difference('Switch.count') do
      post :create, switch: { ip: @switch.ip, login: @switch.login, name: @switch.name, pass: @switch.pass, snmp: @switch.snmp }
    end
  ...
  test "should update switch" do
    patch :update, id: @switch, switch: { ip: @switch.ip, login: @switch.login, name: @switch.name, pass: @switch.pass, snmp: @switch.snmp }
    assert_redirected_to switch_path(assigns(:switch))
  end
